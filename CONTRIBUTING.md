# Contributing to projects-data-api

## Code Contributions

#### Step 1: Clone

Clone the project on [GitHub](https://github.com/renderforest/projects-data-api.git)
   
   ``` bash
   $ git clone https://github.com/renderforest/projects-data-api.git
   $ cd projects-data-api
   ```
